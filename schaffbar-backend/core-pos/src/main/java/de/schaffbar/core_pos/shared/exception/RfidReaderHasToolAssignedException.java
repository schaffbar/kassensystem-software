...
public class RfidReaderHasToolAssignedException extends RuntimeException {
    ...
    private static final String MESSAGE = "Cannot change type of RFID reader [id: %s] because it is currently assigned to a tool. " +
            "Please unassign the tool first before changing the type.";
